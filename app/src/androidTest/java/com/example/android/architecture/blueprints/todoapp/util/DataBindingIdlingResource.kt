...
/*custom idling resource for data binding. Espresso uses a different mechanism than data binding, the
Choreographer class, to synchronize its view updates, so it is not aware of data binding changes.*/
